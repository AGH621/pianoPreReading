...
function black_transpose() {
    ...
    for (let i=0; i<the_cs.length; i++) {
        the_cs[i].src = "../../images/pngs/single_c_sharp.png"
    }
    ...
    for (let i=0; i<the_csharps.length; i++) {
        the_csharps[i].src = "../../images/pngs/single_c_sharp.png"
    }
}
...
function white_transpose() {
    ...
    for (let i=0; i<the_cs.length; i++) {
        the_cs[i].src = "../../images/pngs/single_c.png"
    }
    ...
    for (let i=0; i<the_csharps.length; i++) {
        the_csharps[i].src = "../../images/pngs/single_c.png"
    }
}
