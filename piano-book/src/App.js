...
import { Button, Box, Tab, Grid} from '@mui/material';
import { TabsUnstyled, TabUnstyled } from '@mui/base';
...
export default function NavTabs() {
  ...
  return (
    ...
    //These need to be in a separate function for the bottom navbar.
    <Box sx={{ width: '100%' }}>
      <TabsUnstyled value={value} onChange={handleChange} aria-label="extra navigation">
        <LinkTab label="About" href="/about" />
        <LinkTab label="Ta-Ka-Di-Mi" href="/ta_ka_di_mi" />
      </TabsUnstyled>
    </Box>
  );
}*/
...
/*
<Box sx={{ width: '100%' }}>
  <TabsUnstyled value={value} onChange={handleChange} aria-label="unit topic navigation">
